...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...(await metadatosDePagina(idioma, "terminos")),
...
export default async function TerminosPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <DatosEstructurados datos={await grafoPagina(idioma, "terminos", [{ texto: t("titulo") }])} />
      <DocumentoLegal
        documento={documentoLegal(idioma, "terminos")}
        clave="terminos"
