...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale: idioma, namespace: "paginas.privacidad" })
  return {
    title: t("titulo"),
    description: t("descripcion"),
    alternates: alternativas(idioma, "privacidad"),
...
export default async function PrivacidadPage({ params }: Props) {
  ...
  return (
    <DocumentoLegal
      documento={documentoLegal(idioma, "privacidad")}
      clave="privacidad"
